# Writing Effective Tools for Agents 精读 导读
...
## 本篇定位
回答“工具怎么写才会被 agent 真正用好”而不是“勉强能调用”。

## 建议阅读顺序
1. [`00-writing-effective-tools-for-agents-deep-dive.md`](./00-writing-effective-tools-for-agents-deep-dive.md)：主精读，聚焦本篇独有命题。
2. [`01-concept-tool-ergonomics.md`](./01-concept-tool-ergonomics.md)：工具人体工学（Tool Ergonomics）
3. [`02-concept-eval-driven-tool-iteration.md`](./02-concept-eval-driven-tool-iteration.md)：评测驱动工具迭代
4. [`03-concept-namespacing-and-semantic-contract.md`](./03-concept-namespacing-and-semantic-contract.md)：命名空间与语义契约
...
## 目录结构说明
- 主文：`00-writing-effective-tools-for-agents-deep-dive.md`
